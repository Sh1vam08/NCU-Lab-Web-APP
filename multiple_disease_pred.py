...
diabetes_model = pickle.load(open('D:/Project ML/New folder/models/diabetes_model.sav', 'rb'))

heart_disease_model = pickle.load(open('D:/Project ML/New folder/models/heart_disease_model.sav','rb'))

parkinsons_model = pickle.load(open('D:/Project ML/New folder/models/parkinsons_model.sav', 'rb'))
